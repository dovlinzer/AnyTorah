...
android {
    namespace = "com.anytorah"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.anytorah"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Navigation — 2.7.x avoids the kotlinx.serialization requirement added in 2.8
    implementation("androidx.navigation:navigation-compose:2.7.7")

    // Coroutines
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.8.1")

    // HTTP (OkHttp, no extra serialization library — use org.json)
    ...
    // Gson for bookmark JSON
    implementation("com.google.code.gson:gson:2.10.1")

    // Coil for image loading (DedicationDialog)
