...
/**
 * A second, self-contained reader — pulled up in a side panel (see Reader.tsx's refPanelOpen/
 * refPanelPosition) so a Teshuvah citing a pasuk or a Shulchan Arukh siman can be looked up
 * without losing your place in the main text. Deliberately has no commentary panel of its own
 * (that's the whole point — Teshuvot's freed-up width is what makes room for this), no
 * highlights/bookmarks/notebook integration, and no persistence of its own position — it always
 * opens back on Tanakh/Bereishit. Those are accepted v1 gaps, not oversights; this is scoped to
 * "look something up alongside the teshuvah," not a peer of the main reader.
 */
